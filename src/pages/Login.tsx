...
const Login = () => {
  ...
  const handleReset = async (data: ResetData) => {
    try { clearMessages(); setLoading(true);
      ...
      setSuccess(`Email de recuperação enviado para ${data.email}. Verifique a sua caixa de entrada (e spam).`);
      resetForm.reset();
                ...
                <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <button type="button" onClick={() => switchMode('reset')} className="text-xs text-primary hover:underline">Esqueceu?</button>
                    </div>
                    <div className="relative">
