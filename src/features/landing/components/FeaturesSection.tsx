  ...
  return (
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black mb-5 font-['Fraunces'] tracking-tight text-balance">
        ...
        <div className={`mb-24 transition-all duration-700 ${featVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-black font-['Fraunces'] tracking-tight">Como funciona</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            ...
            {[
              ...
              <div key={idx} className="relative z-10 flex flex-col items-center text-center">
                ...
                <h4 className="font-bold text-lg mb-2 font-['Fraunces']">{step.title}</h4>
            ...
            >
              ...
              <div className="relative aspect-[16/9] overflow-hidden bg-muted">
                ...
                <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-5">
                  ...
                  <h3 className="text-xl font-bold font-['Fraunces'] text-white">{feature.title}</h3>
                </div>
              </div>
          ...
          <div className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 transition-all duration-700 ${addVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            {additionalFeatures.map((feature, index) => (
              ...
              >
                ...
                <h4 className="font-bold text-sm mb-1.5 font-['Fraunces']">{feature.title}</h4>
