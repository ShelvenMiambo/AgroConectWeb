      ...
      <div className="relative w-full max-w-md bg-card rounded-lg shadow-strong border border-border/60 fade-in-up overflow-hidden">
        ...
        <div className="flex items-center justify-between p-5 border-b border-border/60 bg-muted/30">
          <div>
            ...
            <h3 className="font-black text-xl font-['Fraunces']">Plano {plan.label}</h3>
          </div>
        ...
        <div className="p-6 space-y-5">
          {step === 'success' ? (
            <div className="text-center space-y-4 py-4">
              ...
              <h3 className="text-2xl font-black font-['Fraunces']">Subscrição Ativa!</h3>
            ...
            <div className="text-center space-y-4 py-4">
              ...
              <h3 className="text-xl font-black font-['Fraunces']">Pagamento não concluído</h3>
            ...
            <>
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/40 border border-border/50">
                ...
                <span className="text-2xl font-black text-primary font-['Fraunces']">{plan.price} MT</span>
              </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 lg:px-8 py-10 max-w-5xl pb-24 md:pb-10">
        <h1 className="text-3xl md:text-4xl font-black font-['Fraunces'] mb-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            <Card className="border-border/50 shadow-soft rounded-lg overflow-hidden">
              ...
              <CardContent className="px-6 pb-6 pt-0">
                ...
                <h2 className="text-xl font-black font-['Fraunces'] leading-tight flex items-center gap-1.5">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-border/50 shadow-soft rounded-lg">
              <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4">
                <CardTitle className="text-lg font-black font-['Fraunces']">Dados da Conta</CardTitle>
                {!editing ? (
            ...
            {config.isPromotionActive && (
              <div className="bg-gradient-to-r from-amber-500/10 via-primary/5 to-emerald-500/10 border border-primary/20 text-foreground p-4 rounded-lg flex items-start gap-3 shadow-soft">
                ...
                <div className="space-y-0.5">
                  <h4 className="font-black text-sm font-['Fraunces'] flex items-center gap-2">
            ...
            <Card className="border-border/50 shadow-soft rounded-lg">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg font-black font-['Fraunces'] flex items-center gap-2">
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <p className="font-black text-sm font-['Fraunces']">{plan.label}</p>
                          </div>
                          <div className="text-right">
                            <p className={`text-xl font-black font-['Fraunces'] ${plan.color}`}>{plan.price}<span className="text-xs font-semibold text-muted-foreground"> MT</span></p>
            ...
            <Card className="border-destructive/30 shadow-soft rounded-lg bg-destructive/5">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-black font-['Fraunces'] flex items-center gap-2 text-destructive">
