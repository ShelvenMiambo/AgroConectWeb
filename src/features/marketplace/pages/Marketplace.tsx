    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-card rounded-lg shadow-strong border border-border/60 max-h-[90vh] overflow-y-auto fade-in-up">
        <div className="flex items-center justify-between p-5 border-b border-border/60">
          <h2 className="font-black text-xl font-['Fraunces'] flex items-center gap-2">
...
const ListingModal = ({ listingType, onClose, onSaved, initial }: { listingType: ListingType; onClose: () => void; onSaved: () => void; initial?: Record<string, string> }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-card rounded-lg shadow-strong border border-border/60 max-h-[90vh] overflow-y-auto fade-in-up">
        <div className="flex items-center justify-between p-5 border-b border-border/60">
          <h2 className="font-black text-lg font-['Fraunces'] flex items-center gap-2">
      ...
      <div className="relative w-full max-w-md bg-card rounded-lg shadow-strong border border-border/60 p-6 fade-in-up">
        {userData?.plan === 'gratuito' && !config.isPromotionActive ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h3 className="text-xl font-black font-['Fraunces']">Subscrição Premium Necessária</h3>
          ...
          <>
            <div className="flex justify-between items-start mb-5">
              <div>
                <h3 className="text-lg font-black font-['Fraunces']">Contactar</h3>
        ...
        <main className="container mx-auto px-4 lg:px-8 py-8 max-w-5xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3 space-y-6">
              ...
              <div>
                <h1 className="text-3xl font-black font-['Fraunces'] mb-2">{p.nome}</h1>
              ...
              <Card className="shadow-medium border-border/60 sticky top-20">
                <CardContent className="p-6 space-y-5">
                  <div>
                    ...
                    <p className="text-3xl font-black text-primary font-['Fraunces']">{p.preco.toLocaleString('pt-MZ')} MT</p>
                  </div>
      ...
      <main>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/8 via-background to-accent/5 border-b border-border/60 pt-10 pb-14">
          ...
          <div className="relative container mx-auto px-4 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-black mb-4 font-['Fraunces']">
                        ...
                        {filtered.map((p, i) => {
                          ...
                          return (
                            <div key={p.id || i} className="group relative bg-card rounded-lg border border-border/60 overflow-hidden cursor-pointer card-hover shadow-xs fade-in-up"
                              ...
                              <div className="p-5">
                                <h3 className="font-bold text-base group-hover:text-primary transition-colors font-['Fraunces'] line-clamp-1 mb-1">{p.nome}</h3>
                                ...
                                <div className="flex items-center justify-between">
                                  <span className="text-lg font-black text-primary font-['Fraunces']">{p.preco.toLocaleString('pt-MZ')} MT</span>
