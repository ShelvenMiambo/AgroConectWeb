...
import { getProperties, getUserListings, deleteProperty, deleteListing, Property, Listing, deleteUserAccountData } from '@/lib/firestoreService';
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-border/50 shadow-soft rounded-2xl">
              ...
              <CardContent>
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 sm:pb-0 snap-x snap-mandatory sm:grid sm:grid-cols-2 sm:overflow-visible -mx-1 px-1">
